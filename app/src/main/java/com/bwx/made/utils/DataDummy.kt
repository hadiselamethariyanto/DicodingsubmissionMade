...
object DataDummy {
    ...
    fun generateDummyTv(): List<TvEntity> {
        ...
        tv.add(
            TvEntity(
                ...
                "/rbkGgrEHOPyAEZqPk609QN1Ird6.jpg",
                "/pXjpqrx65mlQskf9mfTWSszYODn.jpg",
                7.9,
                "DC's Stargirl",
                1,
                false,
        ...
        tv.add(
            TvEntity(
                ...
                "2021-07-26",
                "",
                "/43pX5G2eL4H6EppxVcirMxdkcGN.jpg",
                "/bjsoOPkViI5WIREQb94XDeXrZlF.jpg",
                0.0,
                "Ilha Record",
                1,
                false,
        ...
        tv.add(
            TvEntity(
                ...
                "/jOJP93WpQrmSXX16lQCNulwuUVO.jpg",
                8.2,
                "Loki",
                3,
                false,
        ...
        tv.add(
            TvEntity(
                ...
                "2013-09-13",
                "",
                "/7wxCXXqnFxxJtrjHtQldY50dCYS.jpg",
                "",
                9.0,
                "Promi Big Brother",
                1,
        ...
        tv.add(
            TvEntity(
                ...
                "/zJZfxi8X3XPHAhxXseRugtnNVtt.jpg",
                8.8,
                "Rick and Morty",
                5,
                false,
        ...
        tv.add(
            TvEntity(
                ...
                "/lICAhPifWrXpscCvweCrUdCzCuG.jpg",
                "/rSqKcCgC3FvEqXZiY89OEe2vEov.jpg",
                7.4,
        ...
        tv.add(
            TvEntity(
                ...
                "/eyG9srihv68ScRdEbJZj66WT4O0.jpg",
                7.8,
                "The Flash",
                3,
                false,
        ...
        tv.add(
            TvEntity(
                ...
                "2002-06-03",
                "",
                "/cPvXh1UmjZY93Kck3WFW55mb1km.jpg",
                "/pWTP8mJ6mQgfRUlsGmLlKkVISIP.jpg",
                9.3,
                "Sucré Salé",
                7,
                false,
        ...
        tv.add(
            TvEntity(
                ...
                "2021-03-29",
                "",
                "/kdpM5Iz37EWi6hRMWZvrQRxTpEF.jpg",
                "",
                0.0,
                "Noovo Le Fil Québec",
                1,
        ...
        tv.add(
            TvEntity(
                ...
                "/2748H9LoK2oQd9L7ofze8VjCGhS.jpg",
                7.0,
                "Anupamaa",
                1,
                false,
        ...
        tv.add(
            TvEntity(
                ...
                "/wksRAOMoyHDxJWSW6bG4MyECW9G.jpg",
                "",
                4.3,
                "Amor Amor",
                1,
        ...
        tv.add(
            TvEntity(
                ...
                "/A17Rt6BLHno0puR1QXbsSKhBfA4.jpg",
                "/aGULNElJVpSru19WP2pUjopPX1U.jpg",
                8.2,
        ...
        tv.add(
            TvEntity(
                ...
                "2021-03-29",
                "",
                "/x70JHANtSvS8IiTadaDrXY1PQBB.jpg",
                "",
                0.0,
                "Noovo Le Fil 22",
                1,
        ...
        tv.add(
            TvEntity(
                ...
                "/thuQmpI9OZNEUTqkkNsNZVDsgNP.jpg",
                7.7,
                "iCarly",
                1,
                false,
    ...
    fun generateDetailTVDummy(): TvEntity {
        return TvEntity(
            1,
            "2021-08-11",
            "Taking inspiration from the comic books of the same name, each episode explores a pivotal moment from the Marvel Cinematic Universe and turns it on its head, leading the audience into uncharted territory.",
    ...
    fun generateCastMovie(): List<CastEntity> {
        ...
        castList.add(
            CastEntity(
                ...
                "John Cena",
                "/rgB2eIOt7WyQjdgJCOuESdDlrjg.jpg"
            )
        )
        castList.add(
            CastEntity(
                ...
                "Rick Flag",
                "Joel Kinnaman",
                "/3oC3Stq87lFWaxYrlgWTxM8Msqf.jpg"
            )
        )
        castList.add(
            CastEntity(
                75, 1,
                "Nanaue / King Shark (voice)",
                "Sylvester Stallone",
